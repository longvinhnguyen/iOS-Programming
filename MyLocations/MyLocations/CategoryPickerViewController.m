...
{
    [super viewDidLoad];
    categories = [NSArray arrayWithObjects:@"No Category", @"Apple Store", @"Bar", @"Bookstore", @"Club", @"Grocery Store", @"Historical Building", @"House", @"Icecream vendor", @"Landmark", @"Park", nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([categoryName isEqualToString:_selectedCategoryName]) {
