...
- (void)drawRect:(CGRect)rect
{
    ...
    UIColor *blackColor = [UIColor colorWithRed:0.0f green:0.0 blue:0.0 alpha:1.0];
    UIColor *highLightStart = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.4];
    UIColor *hightLightStop = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.1];
    
    UIColor *outerTop = [UIColor colorWithHue:self.hue saturation:self.saturation brightness:1.0*actualBrightness alpha:1.0];
    UIColor *outerBottom = [UIColor colorWithHue:self.hue saturation:self.saturation brightness:0.8*actualBrightness alpha:1.0];
    ...
    CGFloat hightLightMargin = 2.0;
    CGRect hightlightRect = CGRectInset(outerRect, hightLightMargin, hightLightMargin);
    CGMutablePathRef hightLightPath = createRoundedRectForRect(hightlightRect, 6.0);
    ...
    if (self.state != UIControlStateHighlighted) {
        ...
        CGContextAddPath(context, outerPath);
        CGContextAddPath(context, hightLightPath);
        CGContextEOClip(context);
        drawGlossAndGradient(context, outerRect, highLightStart.CGColor, hightLightStop.CGColor);
        CGContextRestoreGState(context);
    }
