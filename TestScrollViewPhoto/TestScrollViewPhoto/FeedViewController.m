...
- (void)viewDidLoad
{
    ...
    NSDictionary *data5 = [NSDictionary dictionaryWithObjectsAndKeys:@"All along I believe I would find you. Time has brought heart to me.", @"message", @"0", @"likes", @"0", @"comments", nil];
...
- (float)configureHeightForIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGSize messageSize = [message sizeWithFont:[UIFont systemFontOfSize:17] constrainedToSize:CGSizeMake(280, 40)];
