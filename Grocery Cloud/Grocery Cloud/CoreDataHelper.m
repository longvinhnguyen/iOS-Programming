...
#pragma mark - FILES
NSString *storeFilename = @"Grocery-Cloud.sqlite";
...
- (id)init {
    ...
    // API VERSION 0 = Dev, 1 = Prod
    _stackMobClient = [[SMClient alloc] initWithAPIVersion:@"0" publicKey:@"e94e8d18-0c87-470c-814e-d885f2978522"];
...
//    [self loadStore];
//    //[self importGroceryCloudTestData];
...
- (void)importGroceryCloudTestData {
    if (debug==1) {
        NSLog(@"Running %@ '%@'", self.class, NSStringFromSelector(_cmd));
    }
    NSNumber *imported =
